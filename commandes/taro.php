...
<body>
    ...
    <div class="container">
        <div class="image-section">
            <img src="../images/taro-sauce-jaune.jpeg" alt="Restaurant Image" data-aos="fade-down" data-aos-duration="1000" data-aos-delay="400">
        </div>
        <div class="form-section" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="400">
        <form action="traitement_taro.php" method="POST">
            <h2>Faite Vos Commandes</h2>
            <label for="nom"></label>
            <input type="text" id="nom" name="nom" value="Taro sauce jaune" readonly>
            <label for="prix"></label>
            <input type="text" id="prix" name="prix" value="1500"  style="color: red;" readonly>
