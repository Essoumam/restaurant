...
<body>
    <div class="container">
        <div class="image-section">
            <img src="../images/Le_Eru.jpg" alt="Restaurant Image" data-aos="fade-down" data-aos-duration="1000" data-aos-delay="400">
        </div>
        <div class="form-section" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="400">
        <form action="traitement_eru.php" method="POST">   
           <h2>Faite Vos Commandes</h2>
            <label for="nom"></label>
            <input type="text" id="nom" name="nom" value="Eru" readonly>
